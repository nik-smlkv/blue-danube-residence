...
function filterNameInput(value) { return value.replace(/[^A-Za-zА-Яа-яЁёЉЊЂЃҐЌЏŠŽČĆĐšžčćđјљњћўїєіё\s\-]/g, ""); }
// --- Инициализация формы ---
function initForm(formId) {
	...
	usernameInput.addEventListener("input", () => {
		usernameInput.value = filterNameInput(usernameInput.value);
